  ...
  return (
    <main className="flex flex-col min-h-screen bg-luna">
      ...
      <section className="flex-grow flex flex-col items-center justify-center text-center px-6 py-24">
        <h1 className="font-falsenine-mainheading text-5xl md:text-6xl tracking-widest mb-6">
        ...
        <button className="mt-10 px-8 py-3 bg-flame text-night rounded-xl font-falsenine tracking-wider hover:bg-flame/80 transition">
          ENTER THE PLAY
        </button>
      </section>
    </main>
